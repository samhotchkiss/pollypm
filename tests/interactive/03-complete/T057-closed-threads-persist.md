...
Closed thread moves to inbox/closed/ directory with messages subdirectory preserved. File persists on disk for historical reference.

### Re-test — 2026-04-10 (verified from T054)

Closed thread moved to inbox/closed/ directory and persisted on disk. Thread directory with messages preserved. ✅

### Deep test — 2026-04-10 (verified on disk)

Closed thread moved to inbox/closed/test-thread/ with state.json containing full 5-transition history. Thread persists in closed/ directory. ✅
