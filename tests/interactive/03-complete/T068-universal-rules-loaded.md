...
### Re-test — 2026-04-10 (verified via BOTH operator and heartbeat sessions)

Asked heartbeat: "What rules and magic are in your instructions?"
```
Rules: audit, bugfix, build
Magic: deploy-site, visual-explainer
```
Same result as operator (T023). Both sessions loaded the same universal rules from pollypm/defaults/. ✅
