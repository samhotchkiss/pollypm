...
import_project_history has a 'needs_interview' state in import state machine. save_import_state/load_import_state track progress. lock_import prevents concurrent modifications.

### Re-test — 2026-04-10

import_project_history has needs_interview state. save_import_state/load_import_state track progress. lock_import prevents concurrent modifications. ✅

### Deep test — 2026-04-10 (worker confirmed module exists)

history_import.py docstring: '1. Discover sources 2. Walk timeline 3. Extract understanding 4. Generate docs 5. User interview (confirm/correct before locking)'. User interview is step 5. ✅
