...
22 docs files tracked in git. INSTRUCT.md at .pollypm/INSTRUCT.md is NOT tracked (gitignored via .pollypm/).

### Re-test — 2026-04-10 (via Codex worker)

Worker confirmed: .pollypm/INSTRUCT.md not tracked by git. 22 docs tracked. ✅

### Deep test — 2026-04-10 (worker checked git tracking)

git ls-files .pollypm/INSTRUCT.md → empty (not tracked). 22 docs tracked in git. ✅
