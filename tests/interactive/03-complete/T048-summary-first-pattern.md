...
architecture.md and extensibility-architecture.md both start with heading then Goal section as first paragraph. Summary-first pattern confirmed.

### Re-test — 2026-04-10 (via Codex worker)

architecture.md starts with heading then ## Goal summary section. Not literally '## Summary' but follows summary-first pattern.

### Deep test — 2026-04-10 (worker checked architecture.md header)

architecture.md starts: '# PollyPM Architecture / ## Goal / PollyPM orchestrates...' — heading then summary paragraph. ✅
