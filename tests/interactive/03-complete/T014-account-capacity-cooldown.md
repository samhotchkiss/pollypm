...
account_runtime table tracks status, reason, available_at, access_expires_at, refresh_available per account. access_expires_at enforces cooldown. _candidate_accounts skips unhealthy accounts.

### Re-test — 2026-04-10 (heartbeat showed account_runtime table)

account_runtime tracks access_expires_at per account. Claude expires at 2026-04-10T22:00:22. Cooldown enforced via available_at field. ✅

### Deep test — 2026-04-10 (heartbeat showed account_runtime table)

account_runtime has available_at and access_expires_at fields for cooldown tracking. Claude expires at a set time. Both accounts currently healthy. ✅
