...
from promptmaster.projects import ensure_project_scaffold, project_artifacts_dir, project_dossier_dir
...
class FileMemoryBackend(MemoryBackend):
    def __init__(self, project_path: Path, *, state_db: Path | None = None) -> None:
        ...
        self.state_db = state_db or (self.project_path / ".promptmaster" / "state.db")
