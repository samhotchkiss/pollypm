...
DEFAULT_MAX_CHARS=32000. Priority-based truncation: blockers/next_step/working_on=1 (kept), completed=2, git_state=3, project_context=5 (trimmed first). _truncate_sections removes lowest-priority sections first.

### Re-test — 2026-04-10 (confirmed via code + heartbeat)

DEFAULT_MAX_CHARS=32000. Priority truncation: blockers(1), next_step(1), working_on(1) kept; project_context(5) trimmed first. ✅

### Deep test — 2026-04-10

DEFAULT_MAX_CHARS=32000. Priority truncation: blockers(1) kept, project_context(5) trimmed first. ✅
